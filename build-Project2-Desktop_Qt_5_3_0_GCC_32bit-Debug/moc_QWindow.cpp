...
#include "../2048/Project2/QWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWindow_t, stringdata) + ofs \
...
const QMetaObject QWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QWindow.data,
      qt_meta_data_QWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWindow.stringdata))
