...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTile_t, stringdata) + ofs \
...
const QMetaObject QTile::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_QTile.data,
      qt_meta_data_QTile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTile.stringdata))
