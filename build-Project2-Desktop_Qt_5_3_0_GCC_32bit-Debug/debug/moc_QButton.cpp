...
#include "../../2048/Project2/QButton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QButton_t, stringdata) + ofs \
...
void QButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QButton *_t = static_cast<QButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (QButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QButton::clicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QButton.data,
      qt_meta_data_QButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QButton.stringdata))
        return static_cast<void*>(const_cast< QButton*>(this));
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< QButton*>(this));
